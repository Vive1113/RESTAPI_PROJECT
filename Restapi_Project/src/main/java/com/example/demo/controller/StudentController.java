...
import com.example.demo.serviceImplements.StudentServiceImplements;
...
public class StudentController {
	public StudentServiceImplements studentServ;
	
	public StudentController(StudentServiceImplements studentServ) {
